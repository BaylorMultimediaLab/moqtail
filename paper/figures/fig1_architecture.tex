...
\begin{tikzpicture}[
  ...
  inner/.style={
    ...
    align=center, font=\rmfamily\scriptsize\itshape,
    line width=0.4pt
  },
...
\draw[flow] (pub) -- node[above, font=\rmfamily\scriptsize, midway]
...
\draw[flow, alignedblue] (relay.east) --
  node[above=1mm, midway, font=\rmfamily\scriptsize, text=alignedblue, align=center]
