...
NOTEBOOK_TO_PDF = {
    ...
    "fig3_trace_naive_vs_aligned.ipynb": "fig3_trace_naive_vs_aligned.pdf",
    "fig4_e4_cache_boundary.ipynb": "fig4_e4_cache_boundary.pdf",
    "fig5_e6_composability.ipynb": "fig5_e6_composability.pdf",
}


@pytest.mark.parametrize("notebook,pdf", NOTEBOOK_TO_PDF.items())
def test_notebook_executes_and_emits_pdf(notebook, pdf, tmp_path):
